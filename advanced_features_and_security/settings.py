...
import os # Added for MEDIA_ROOT configuration
...
INSTALLED_APPS = [
    ...
    # --- Step 1: Custom App Registration ---
    # Register the application containing the CustomUser model
    'users', 
]
...
# Step 2: Configure Django to use the CustomUser model for authentication
AUTH_USER_MODEL = 'users.CustomUser'

# Media configuration for profile_photo field (ImageField)
MEDIA_URL = '/media/'
